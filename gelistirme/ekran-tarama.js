...
const EKRANLAR = [
  ...
  ['29a-sms', '?ekran=sms', 'SMS Gönderimi'],
  ...
  ['29f-personel', '?ekran=personel', 'Personel Listesi'],
  ['29g-personel-kart', '?ekran=personel&id=7', 'Personel Kartı'],
  ['29h-personel-ayrilan', '?ekran=personel&durum=ayrilan', 'Personel · Ayrılanlar'],
